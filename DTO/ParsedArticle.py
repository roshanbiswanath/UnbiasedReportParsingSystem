...
class ParsedArticle(BaseModel):
    ...
    is_aggregated: bool = Field(False, description="Flag to indicate if the article has been passed into the AI pipeline")
    class Config:
        schema_extra = {
            "example": {
    ...
    def __str__(self):
        return f"ParsedArticle(title={self.title}, content={self.content}, url={self.url}, source={self.source}, published_at={self.published_at})"
